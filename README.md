...
RfLogger.configure do |c|
  c.environment = 'production' # attempts to determine this for Rails, Sinatra, Padrino, and Rory, but is otherwise required
...
As you can see above, you can specify different notifications for different levels or environments whend you log an event.  See more about notification below.
